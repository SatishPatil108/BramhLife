...
const MusicList = () => {
  ...
  const dispatch = useDispatch();
    ...
    return (
        <div className="bg-white pb-8 overflow-x-auto mb-0 lg:mb-10 scrollbar-thin scrollbar-thumb-purple-300 scrollbar-track-transparent">
            <h2 className="px-4 sm:px-6 text-2xl md:text-3xl font-bold mt-4">
                Sounds and Musics
            </h2>
            {/* Loading / Error */}
            {loading ? (
                ...
                <div
                    className="flex overflow-x-auto space-x-4 mt-8 pb-12 px-6  snap-x snap-mandatory scrollbar-hide"
                >
                    {musics.map((music) => (
                        <motion.div
                            key={music.id}
                        ...
                        >
                          ...
                          text-white bg-black/50 opacity-100 group-hover:opacity-50 
                            transition-all duration-300">
                                ...
                                <h1 className="text-base font-medium">{music.music_title}</h1>
